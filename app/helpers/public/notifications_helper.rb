module Public::NotificationsHelper
  def notification_form(notification)
    ...
    case notification.action
      ...
      when "favorite" then
        tag.a(notification.visiter.name, href: customer_path(@visiter), class: "font-weight-bold text-dark") + "が" + tag.a("あなたの投稿", href: recipe_path(notification.recipe_id), class: "font-weight-bold text-dark") + "をお気に入りしました"
      when "review" then
